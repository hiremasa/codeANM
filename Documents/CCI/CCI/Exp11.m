...
%     [ind1,gSquare1;ind2,gSquare2]
    if ind1+ind2 == 2 && indx == 0 && gSquarex > 20
        break;
    end
end
...
resultM2 =  [ANMs(x2, y, alpha, 0),ANMs(y, x2, alpha, 0),MaxMI(x1,x1,y)];
resultM3 =  [ANMs(x, y, alpha, 0),ANMs(y, x, alpha, 0),MaxMI(x,[x1,x2],y)];
p_val_XtoY_and_p_val_YtoX_and_d_val = [resultM1;resultM2;resultM3]
